...
def clarification_node(state: ResearchState) -> dict:
    ...
    llm = ChatAnthropic(model_name="claude-3-5-sonnet-20241022", temperature=0.3)  # type: ignore
...
def research_node(state: ResearchState) -> dict:
    ...
    research_agent = create_react_agent(
        model=ChatAnthropic(model_name="claude-3-5-sonnet-20241022", temperature=0.3),
        tools=[tavily_tool],
